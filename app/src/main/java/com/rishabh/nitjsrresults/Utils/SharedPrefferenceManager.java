...
public class SharedPrefferenceManager {
    ...
    private static SharedPrefferenceManager sSharedPrefs;
    ...
    private SharedPrefferenceManager(Context context) {
        mPref = context.getSharedPreferences(SETTINGS_NAME, Context.MODE_PRIVATE);
    }


    public static SharedPrefferenceManager getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new SharedPrefferenceManager(context.getApplicationContext());

        }
        return sSharedPrefs;
    }

    public static SharedPrefferenceManager getInstance() {
        if (sSharedPrefs != null) {
            return sSharedPrefs;
        }
